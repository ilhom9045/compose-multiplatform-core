 ...
 */
// Flattened expect/actual: upstream declares FontScaling as an `expect interface` here and aliases
// it to FontScalingLinear from FontScacling.nonAndroid.kt. The guest has a single leaf js source set,
// so that alias is inlined. Unchanged otherwise.
typealias FontScaling = FontScalingLinear
