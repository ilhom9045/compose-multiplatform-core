...
class ComposeUiTestTestCopyFromAosp {
    ...
    fun testControlledScrolling() = runComposeUiTest {
        ...
        fun WithTouchSlop(touchSlop: Float, content: @Composable () -> Unit) {
            ...
            val newConfiguration = remember(touchSlop) {
                object : ViewConfiguration by currentViewConfiguration {
                    override val touchSlop: Float get() = touchSlop
                }
            }

            CompositionLocalProvider(LocalViewConfiguration provides newConfiguration) {
                content()
            }
        }
