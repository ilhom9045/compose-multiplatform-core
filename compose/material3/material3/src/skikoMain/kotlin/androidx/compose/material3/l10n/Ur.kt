...
internal fun Translations.ur() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "مزید اختیارات",
    ...
    Strings.FloatingToolbarMoreOptions to "مزید اختیارات",
    ...
    Strings.TimePickerToggleKeyboard to "ٹیکسٹ اِن پٹ موڈ پر سوئچ کریں",
    Strings.TimePickerToggleScroll to "اسکرول وضع پر سوئچ کریں",
    Strings.TimePickerToggleTouch to "گھڑی موڈ پر سوئچ کریں",
    Strings.TimePickerDialogTitle to "وقت منتخب کریں",
    Strings.TimeScrollDialogTitle to "وقت منتخب کریں",
