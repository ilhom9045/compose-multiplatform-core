...
internal fun Translations.sw() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "Chaguo zaidi",
    ...
    Strings.FloatingToolbarMoreOptions to "Chaguo zaidi",
    ...
    Strings.TimePickerToggleKeyboard to "Badilisha utumie mipangilio ya kuingiza data ya maandishi",
    Strings.TimePickerToggleScroll to "Badilisha utumie hali ya kusogeza",
    Strings.TimePickerToggleTouch to "Badilisha utumie hali ya saa",
    Strings.TimePickerDialogTitle to "Chagua Muda",
    Strings.TimeScrollDialogTitle to "Teua Muda",
