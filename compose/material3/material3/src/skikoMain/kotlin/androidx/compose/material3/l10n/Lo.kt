...
internal fun Translations.lo() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "ຕົວເລືອກເພີ່ມເຕີມ",
    ...
    Strings.FloatingToolbarMoreOptions to "ຕົວເລືອກເພີ່ມເຕີມ",
    ...
    Strings.TimePickerToggleKeyboard to "ສະຫຼັບໄປໃຊ້ໂໝດປ້ອນຂໍ້ຄວາມ",
    Strings.TimePickerToggleScroll to "ປ່ຽນເປັນໂໝດເລື່ອນ",
    Strings.TimePickerToggleTouch to "ສະຫຼັບໄປຫາໂໝດໂມງ",
    Strings.TimePickerDialogTitle to "ເລືອກເວລາ",
    Strings.TimeScrollDialogTitle to "ເລືອກເວລາ",
