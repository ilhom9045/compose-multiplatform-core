...
internal fun Translations.kk() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "Басқа опциялар",
    ...
    Strings.FloatingToolbarMoreOptions to "Басқа опциялар",
    ...
    Strings.TimePicker24HourError to "Сағат 0–23 болуы керек.",
