...
internal fun Translations.or() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "ଅଧିକ ବିକଳ୍ପ",
    ...
    Strings.FloatingToolbarMoreOptions to "ଅଧିକ ବିକଳ୍ପ",
    ...
    Strings.TimePickerToggleKeyboard to "ଟେକ୍ସଟ ଇନପୁଟ ମୋଡକୁ ସ୍ୱିଚ କରନ୍ତୁ",
    Strings.TimePickerToggleScroll to "ସ୍କ୍ରୋଲ ମୋଡକୁ ସ୍ୱିଚ କରନ୍ତୁ",
    Strings.TimePickerToggleTouch to "ଘଣ୍ଟା ମୋଡକୁ ସ୍ୱିଚ କରନ୍ତୁ",
    Strings.TimePickerDialogTitle to "ସମୟ ଚୟନ କରନ୍ତୁ",
    Strings.TimeScrollDialogTitle to "ସବୁ ଚୟନ କରନ୍ତୁ",
