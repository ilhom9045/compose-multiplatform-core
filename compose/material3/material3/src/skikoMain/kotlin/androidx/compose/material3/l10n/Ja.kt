...
internal fun Translations.ja() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "その他のオプション",
    ...
    Strings.FloatingToolbarMoreOptions to "その他のオプション",
    ...
    Strings.TimePickerToggleKeyboard to "テキスト入力モードに切り替える",
    Strings.TimePickerToggleScroll to "スクロール モードに切り替え",
    Strings.TimePickerToggleTouch to "時計モードに切り替える",
    Strings.TimePickerDialogTitle to "時刻の選択",
    Strings.TimeScrollDialogTitle to "時間の選択",
