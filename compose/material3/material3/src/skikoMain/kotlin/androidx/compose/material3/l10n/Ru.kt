...
internal fun Translations.ru() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "Ещё",
    ...
    Strings.FloatingToolbarMoreOptions to "Ещё",
    ...
    Strings.TimePickerToggleKeyboard to "Перейти в режим ввода текста",
    Strings.TimePickerToggleScroll to "Переключиться в режим прокрутки",
    Strings.TimePickerToggleTouch to "Перейти в режим часов",
    Strings.TimePickerDialogTitle to "Выберите время",
    Strings.TimeScrollDialogTitle to "Выберите время",
