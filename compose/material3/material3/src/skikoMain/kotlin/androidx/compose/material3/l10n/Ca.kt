...
internal fun Translations.ca() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "Més opcions",
    ...
    Strings.FloatingToolbarMoreOptions to "Més opcions",
    ...
    Strings.TimePickerToggleKeyboard to "Canvia al mode d\'introducció de text",
    Strings.TimePickerToggleScroll to "Canvia al mode de desplaçament",
    Strings.TimePickerToggleTouch to "Canvia al mode de rellotge",
    Strings.TimePickerDialogTitle to "Selecciona l\'hora",
    Strings.TimeScrollDialogTitle to "Selecciona l\'hora",
